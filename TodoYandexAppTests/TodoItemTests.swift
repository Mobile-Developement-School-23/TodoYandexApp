...
final class TodoItemTests: XCTestCase {
    ...
    func testInit() {
        ...
        let now = Date.now
        let item2 = TodoItem(id: "1", text: "1", importance: .low, deadline: now,
                             done: true, createdAt: now, changedAt: now)
    ...
    func testTwoItemsComparing() {
        let now = Date.now
        let item1 = TodoItem(id: "123", text: "Test text", importance: .important,
                             deadline: now.addingTimeInterval(7200), done: false,
                             createdAt: now, changedAt: now.addingTimeInterval(3600))
    ...
    private func checkJsonDictsEquality(_ json1: [String: Any], _ json2: [String: Any]) -> Bool {
        return json1["id"] as? String == json2["id"] as? String
        && json1["text"] as? String == json2["text"] as? String
        && json1["done"] as? Bool == json2["done"] as? Bool
        && json1["importance"] as? String == json2["importance"] as? String
        && json1["deadline"] as? TimeInterval == json2["deadline"] as? TimeInterval
        && json1["createdAt"] as? TimeInterval == json2["createdAt"] as? TimeInterval
        && json1["changedAt"] as? TimeInterval == json2["changedAt"] as? TimeInterval
    }
    ...
    func testJsonParse() {
        ...
        let jsonDict1 = ["id": "0", "text": "TestText", "done": false, "importance": "low",
                         "deadline": 1686904696.0, "createdAt": 1686904696.0, "changedAt": 1686904696.0]
        as [String: Any]
        let item1Reference = TodoItem(id: "0", text: "TestText", importance: .low, deadline: dateExample,
                                      done: false, createdAt: dateExample, changedAt: dateExample)
        ...
        let item2Reference = TodoItem(id: "0", text: "TestText", importance: .basic, deadline: nil,
                                      done: false, createdAt: dateExample, changedAt: nil)
        let item2 = TodoItem.parse(fromDictionary: jsonDict2)
        XCTAssertEqual(item2, item2Reference)

        let jsonDict3 = ["id": "0", "done": false, "deadline": 1686904696.0, "createdAt": 1686904696.0,
                         "changedAt": 1686904696.0] as [String: Any]
    ...
    func testJsonSerializing() {
        ...
        let dictReference1 = ["id": "0", "text": "TestText", "done": false, "importance":
                                "low", "deadline": 1686904696.0, "createdAt": 1686904696.0, "changedAt": 1686904696.0]
        as [String: Any]
        let item1 = TodoItem(id: "0", text: "TestText", importance: .low, deadline: dateExample,
                             done: false, createdAt: dateExample, changedAt: dateExample)
    ...
    func testJsonFlow() {
        let item = TodoItem(text: "Test text", importance: .important,
                            deadline: Date.now.addingTimeInterval(7200), done: false,
    ...
    func testCsvSerializing() {
        ...
        let csvReference2 = "\"0\";\"TestText\";\"false\";\"\";\"\";\"1686904696.0\";\"\""
        let item2 = TodoItem(id: "0", text: "TestText", importance: .basic, deadline: nil, done: false,
                             createdAt: dateExample, changedAt: nil)
        let csv2 = item2.csv
