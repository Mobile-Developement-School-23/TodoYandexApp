...
final class FileCacheTests: XCTestCase {
    ...
    func testFileSaveAndLoad() {
        ...
        let item2 = TodoItem(id: "123", text: "Test text", importance: .important, deadline: Date.now.addingTimeInterval(7200), done: false, createdAt: Date.now, changedAt: Date.now.addingTimeInterval(3600))
        fileCache.set(item: item1)
        fileCache.set(item: item2)
