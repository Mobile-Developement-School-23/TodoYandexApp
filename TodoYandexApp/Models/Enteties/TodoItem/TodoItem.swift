...
struct TodoItem: Identifiable, Equatable {
    ...
    init(id: String = UUID().uuidString, text: String, importance: TodoItemImportance = .basic, deadline: Date? = nil, done: Bool = false, createdAt: Date = Date.now, changedAt: Date? = nil) {
        self.id = id
        self.text = text
